          ...
          <div className="text-base font-poppins flex justify-center items-center mb-4 mt-52 left-[0.5rem]">
            <div className="flex flex-col space-y-4 sm:left-0 md:left-[-0.5rem] lg:left-[-1rem] xl:left-[-1.5rem] pl-[1rem]">
              <div className="flex sm:flex-col md:flex-col lg:flex-col xl:flex-col items-start">
                ...
                <input type="text" placeholder="Enter your email" className="border-none outline-none rounded-md p-2 mb-2 bg-whitesmoke-200 w-full sm:w-[429.1px] h-[30px] pt-3" />
              </div>
              <div className="flex flex-col items-start">
                <label htmlFor="input2" className="text-gray-800 pb-1 text-sm">Password</label>
                <input type="text" placeholder="Enter your password" className="border-none outline-none rounded-md p-2 mb-2 bg-whitesmoke-200 w-full sm:w-[429.1px] h-[30px] pt-3" />
              </div>
